...
const HUGGINGFACE_TOKEN = process.env.HUGGINGFACE_TOKEN || 'stubKey';
...
const TableQuestionAnswering = async (
  inputs,
...
const TextGenerationStream = async (
  inputs,
  parameters = {},
...
const TokenClassification = async (
  inputs,
...
const SentenceSimilarity = async (
  inputs,
...
const AutomaticSpeechRecognition = async (
  data,
...
const ZeroShotImageClassification = async (
  inputs,
  parameters = {},
...
const VisualQuestionAnswering = async (
  inputs,
...
const TabularClassification = async (
  inputs,
...
const CustomCallStreaming = async (
  inputs,
  parameters = {},
  model = 'my-custom-model',
) => {
...
const CustomInferenceEndpoint = async (inputs, endpoint) => {
  ...
  try {
    ...
    throw new Error('Error occured while triggering "textGeneration" method', {
      cause: err,
    });
  }
};
